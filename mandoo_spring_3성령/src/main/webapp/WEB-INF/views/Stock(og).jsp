...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/CSS/재고현황.css">
</head>
<body>
	<!-- 메인 -->
	...
	<div class="content">
		...
		<div class="mtab">
			<form method="get" action="StockogSelect">
				<input type="text" name="search" value="${searchKeyword}"
					placeholder="검색어 입력">
				<button type="submit" id="search-button">검색</button>
				<button type="button"
					onclick="location.href='${pageContext.request.contextPath}/Stock(og)'"
				...
				<tbody>
					<c:forEach var="stock" items="${list}">
						<tr>
							...
							<td><img class="imgg"
								src="${pageContext.request.contextPath}/image/${stock.item_Code}.jpg"
