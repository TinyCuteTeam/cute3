      ...
      <div id="modal" class="modal">
         <div class="modal-content">
            <div>
               ...
               <span class="close" onclick="closeModal()"><img src="${pageContext.request.contextPath}/resources/image/close.png"></span>
            </div>
            ...
            <button id="addEventButton" onclick="showAddEventContainer()">
               <img src="${pageContext.request.contextPath}/resources/image/write.png" class="write1">
               <img src="${pageContext.request.contextPath}/resources/image/write2.png" style="display: none;" class="write2">
            </button>
            ...
            <div id="eventDetail" style="display: none;">
               ...
               <button id="editEventButton" class="edit-event" onclick="editEvent()">
                  <img src="${pageContext.request.contextPath}/resources/image/edit.png" class="edit1">
                  <img src="${pageContext.request.contextPath}/resources/image/edit2.png" style="display: none;" class="edit2">
               </button>
               <!-- 수정 버튼 -->
