...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/CSS/사내게시판.css">
</head>
...
<body>
    ...
    <div class="content">
        <h1>사내 게시판</h1>
        <form method = "get" action = "board/add">
            ...
            <tbody>
                <c:forEach var="post" items="${posts}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/board/detail?bord_id=${post.bord_Id}">${post.board_Title}</a></td>
        ...
        <div class="pagination">
            ...
            <c:forEach var="i" begin="1" end="${totalPages}">
                <a href="${pageContext.request.contextPath}/boardList?page=${i}" class="${i == currentPage ? 'active' : ''}">${i}</a>
            </c:forEach>
