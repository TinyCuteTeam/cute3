    ...
    <div class="content">
        ...
        <div class="mtab">
            <form method="get" action="${pageContext.request.contextPath}/MaterialStockInventory">
                ...
                <button type="button" onclick="location.href='${pageContext.request.contextPath}/MaterialStockInventory'" class="add-button">초기화</button>
            </form>
        </div>
        ...
        <div class="pagination">
            <c:forEach var="i" begin="1" end="${totalPages}" step="1">
                <a href="${pageContext.request.contextPath}/MaterialStockInventory?page=${i}&search=${searchKeyword}"
